...
// Run: node setup.js → then follow the final instructions.
...
<head>
    ...
    <meta name="description" content="iconelectro – Smart Solar Energy Solutions. Save up to 80% on bills with Tier-1 panels.">
    <meta name="theme-color" content="#f97316">
    <title>iconelectro – Smart Solar Energy</title>
...
<body class="antialiased">
    ...
    <section id="home" class="relative min-h-screen flex items-center overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10 py-24 md:py-32">
            <div class="banner-content text-white" data-aos="fade-up" data-aos-duration="800">
                ...
                <h1 class="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold tracking-tight leading-[1.1] mb-6 font-display text-white drop-shadow-lg">
                    Power Your Future with <span class="text-orange-400">Smart Solar</span> Energy
                </h1>
                <p class="text-lg md:text-xl text-gray-200 mb-8 leading-relaxed max-w-xl drop-shadow-md">
        ...
        <div class="absolute bottom-8 left-1/2 -translate-x-1/2 z-20 flex items-center gap-3">
            <button class="banner-dot active" data-slide="0" aria-label="Slide 1"></button>
            <button class="banner-dot" data-slide="1" aria-label="Slide 2"></button>
            <button class="banner-dot" data-slide="2" aria-label="Slide 3"></button>
        </div>
    </section>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8" data-aos="fade-up" data-aos-delay="100">
                <div class="card-premium p-8 rounded-2xl text-center group relative overflow-hidden">
                    ...
                    <ul class="text-sm text-left space-y-2 text-zinc-600 dark:text-zinc-400 mb-5">
                        <li class="flex items-center gap-2"><i data-lucide="check-circle" class="w-4 h-4 text-emerald-500"></i> 1KW - 10KW Systems</li>
                        <li class="flex items-center gap-2"><i data-lucide="check-circle" class="w-4 h-4 text-emerald-500"></i> Government Subsidy</li>
                    </ul>
                ...
                <div class="card-premium p-8 rounded-2xl text-center group relative overflow-hidden">
                    ...
                    <ul class="text-sm text-left space-y-2 text-zinc-600 dark:text-zinc-400 mb-5">
                        <li class="flex items-center gap-2"><i data-lucide="check-circle" class="w-4 h-4 text-sky-500"></i> 10KW - 100KW Systems</li>
                        <li class="flex items-center gap-2"><i data-lucide="check-circle" class="w-4 h-4 text-sky-500"></i> Accelerated Depreciation</li>
                    </ul>
                ...
                <div class="card-premium p-8 rounded-2xl text-center group relative overflow-hidden">
                    ...
                    <ul class="text-sm text-left space-y-2 text-zinc-600 dark:text-zinc-400 mb-5">
                        <li class="flex items-center gap-2"><i data-lucide="check-circle" class="w-4 h-4 text-amber-500"></i> 100KW - 1MW+ Systems</li>
                        <li class="flex items-center gap-2"><i data-lucide="check-circle" class="w-4 h-4 text-amber-500"></i> Custom Engineering & EPC</li>
                    </ul>
    ...
    <!-- Calculator Section -->
    <section id="calculator" class="py-20 md:py-28" style="background: linear-gradient(135deg, #fff7ed, #ffedd5 50%, #fff7ed);">
                ...
                <div class="max-w-xl mx-auto">
                    ...
                    <div class="flex flex-col sm:flex-row gap-3 mb-8">
                        <div class="relative flex-1">
                            ...
                            <input id="billInput" type="number" placeholder="e.g. 4,000" class="w-full pl-10 pr-5 py-4 rounded-xl border-2 text-lg font-medium focus:outline-none focus:border-orange-500 transition" style="border-color: var(--border); background: var(--surface); color: var(--text);">
                        </div>
    ...
    <!-- Why Us Section -->
    <section id="why-us" class="py-20 md:py-28" style="background-color: var(--bg-secondary);">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16" data-aos="fade-up">
    ...
    <!-- FAQ Section -->
    <section id="faq" class="py-20 md:py-28" style="background-color: var(--bg-secondary);">
    ...
    <!-- Footer -->
    <footer class="py-12 border-t" style="background: var(--surface); border-color: var(--border);">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
        <div id="chatPanel" class="w-80 bg-white dark:bg-zinc-900 rounded-2xl shadow-2xl border p-5 hidden" style="border-color: var(--border);">
        ...
        (function() {
            ...
            function setTheme(isDark) {
                if (isDark) {
                    ...
                    if (themeIconDesktop) themeIconDesktop.setAttribute('data-lucide', 'sun');
                    ...
                    if (themeIconDesktop) themeIconDesktop.setAttribute('data-lucide', 'moon');
            ...
            // Chat panel
            function openChatPanel() { chatPanel.classList.remove('hidden'); }
            function closeChatPanel() { chatPanel.classList.add('hidden'); }
            chatToggleBtn.addEventListener('click', () => { chatPanel.classList.contains('hidden') ? openChatPanel() : closeChatPanel(); });
            document.addEventListener('click', (e) => { if (!chatPanel.classList.contains('hidden') && !chatPanel.contains(e.target) && !chatToggleBtn.contains(e.target)) closeChatPanel(); });
            ...
            document.getElementById('home').addEventListener('mouseleave', () => { autoSlideInterval = setInterval(nextSlide, 5000); });
